...
int main() {
    ...
    if (mode == "encrypt") {
        ...
        if(input_file_string == "default")
            input_file_string = "/home/stud/C++Projects/CryptoProg/cipher/file";
        ...
        if(output_file_string == "default")
            output_file_string = "/home/stud/C++Projects/CryptoProg/cipher/rez";
        ...
        ofstream user_password("/home/stud/C++Projects/CryptoProg/cipher/passwd");
        StringSource(pass, true, new FileSink(user_password));
        ofstream key_file("/home/stud/C++Projects/CryptoProg/cipher/key_file");
        ArraySource(key, sizeof(key), true, new FileSink(key_file));
        ofstream IV_file("/home/stud/C++Projects/CryptoProg/cipher/iv_file");
        ...
        string user_pass;
        FileSource("/home/stud/C++Projects/CryptoProg/cipher/passwd", true, new StringSink(user_pass));
        if (pass == user_pass) {
        ...
        cin >> input_file_string;
        if(input_file_string == "default")
            input_file_string = "/home/stud/C++Projects/CryptoProg/cipher/rez";
        ifstream input_check(input_file_string);
        if(input_check.is_open() == 0) {
        ...
        cin >> output_file_string;
        if(output_file_string == "default")
            output_file_string = "/home/stud/C++Projects/CryptoProg/cipher/file1";
        ifstream output_check(output_file_string);
        if(output_check.is_open() == 0) {
            cerr << "Файл не был введен/n" << endl;
            return 1;
        ...
        byte key[Tiger::DIGESTSIZE];
        FileSource("//home/stud/C++Projects/CryptoProg/cipher/key_file", true, new ArraySink(key, sizeof(key)));
        byte IV[ AES::BLOCKSIZE ];
        FileSource("/home/stud/C++Projects/CryptoProg/cipher/iv_file", true, new ArraySink(IV, sizeof(IV)));
